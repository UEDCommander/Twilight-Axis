/obj/item/canvas
	...
	icon = 'modular_twilight_axis/icons/paint_supplies/canvas_32.dmi'
	icon_state = "canvas"
	...
	var/canvas_icon = 'modular_twilight_axis/icons/paint_supplies/canvas/canvas_32x32.dmi'
...
/obj/item/canvas/proc/update_drawing(x, y, current_color)
	...
	var/mutable_appearance/MA = mutable_appearance('modular_twilight_axis/icons/paint_supplies/pixel.dmi', "pixel")
...
/atom/movable/screen/canvas
	icon = 'modular_twilight_axis/icons/paint_supplies/canvas/canvas_32x32.dmi'
	icon_state = "canvas"
	screen_loc = "6,6"
