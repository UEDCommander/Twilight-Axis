/obj/structure/deadbody
	...
	icon = 'modular_deserttown/icons/rw_deadbodies.dmi'
	icon_state = "base"
	density = FALSE
	var/searched = FALSE
	var/list/loot_table
...
/obj/structure/deadbody/adventurer_steel
	...
	loot_table = list(
		...
		/obj/item/clothing/suit/roguetown/armor/plate                	  = 3,
		/obj/item/clothing/head/roguetown/helmet/kettle                   = 10,
	...
	loot_table_lucky = list(
		...
		/obj/item/clothing/suit/roguetown/armor/plate                     = 10,
...
/obj/structure/deadbody/maa
	...
	loot_table = list(
		...
		/obj/item/clothing/cloak/tabard/stabard/guard                     = 10,
		/obj/item/clothing/cloak/tabard/stabard/surcoat/guard             = 6,
		/obj/item/clothing/cloak/tabard/stabard/guardhood                 = 6,
		/obj/item/clothing/suit/roguetown/armor/chainmail                 = 10,
...
/obj/structure/deadbody/greater_skeleton
	...
	loot_table = list(
		...
		/obj/item/skull                                                   = 15,
		/obj/item/rogueweapon/sword/sabre/alloy                           = 15,
		/obj/item/rogueweapon/sword/short/gladius/agladius                = 10,
		/obj/item/rogueweapon/spear/aalloy                                = 10,
		/obj/item/rogueweapon/halberd/bardiche/aalloy                     = 6,
		/obj/item/rogueweapon/greatsword/aalloy                           = 4,
		/obj/item/rogueweapon/flail/aflail                                = 6,
		/obj/item/clothing/suit/roguetown/armor/chainmail/hauberk/aalloy  = 10,
		/obj/item/clothing/under/roguetown/platelegs/aalloy               = 8,
		/obj/item/clothing/wrists/roguetown/bracers/aalloy                = 8,
		/obj/item/clothing/neck/roguetown/chaincoif/iron/aalloy           = 8,
	)
	loot_table_lucky = list(
		/obj/item/rogueweapon/greatsword/aalloy                           = 20,
		/obj/item/rogueweapon/halberd/bardiche/aalloy                     = 18,
		/obj/item/rogueweapon/spear/aalloy                                = 15,
		/obj/item/rogueweapon/flail/aflail                                = 12,
		/obj/item/clothing/suit/roguetown/armor/chainmail/hauberk/aalloy  = 20,
		/obj/item/clothing/under/roguetown/platelegs/aalloy               = 15,
		/obj/item/clothing/wrists/roguetown/bracers/aalloy                = 15,
		/obj/item/clothing/neck/roguetown/chaincoif/iron/aalloy           = 15,
	)
