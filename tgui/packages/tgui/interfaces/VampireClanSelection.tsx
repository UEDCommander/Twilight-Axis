...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  ...
  ru: {
    ...
    clanName: 'Имя клана',
    customNamePlaceholder: 'Назовите свою линию каинитов...',
    customNameHint:
    ...
    caitiffNoDisciplines: 'Каинит выбирает свои дисциплины позже.',
    none: 'Нет.',
    unknown: 'Неизвестно',
    noPowersDocumented: 'Силы не описаны.',
    accept: 'Принять клан',
    close: 'Закрыть',
    warningDefault:
...
const RU_CLANS_BY_NAME: Record<string, ClanLoc> = {
  Nosferatu: {
    ...
    downside: 'уродливое лицо и страдания под ликом Астраты',
    bloodPreference: 'кровь сородичей, кровь мёртвых, кровь паразитов',
    tagline: 'Канализационные жители и сломанные маски',
    lordTitle: 'Носферату',
  },
  'Vitabella Family': {
  ...
  'House Thronleer': {
    name: 'Дом Тронлеер',
    desc: 'Нок, очарованный неутолимой жаждой твоего Дома собирать знания, благословил твою проклятую линию крови. Но Ксайликс сдал плохую карту — проклятие наградило тебя страхом перед прихотями и злыми судьбами.',
    curse: 'Боязнь шутов, одержимость познанием и тяжкая хандра.',
    downside: 'хроническая боязнь шутов, большие штрафы к настроению',
  ...
  'Children of the Abyss': {
    name: 'Дети Бездны',
    desc: 'Дети Бездны — линия крови вампиров, поклоняющихся древним демонам. Из-за родства с нечестивым они крайне уязвимы перед серебром.',
    curse: 'Страх перед Религией.',
    downside: 'горят на солнце и в присутствии последователей богов',
    bloodPreference: 'любая кровь',
    tagline: 'Демоническое начало и слабость к серебру',
    lordTitle: 'Лорд',
  },
  'Crimson Fang': {
    name: 'Багровый Клык',
    desc: 'Багровых Клыков прочие сородичи часто считают опасными убийцами и горлорезами. Но на деле — это стражи, воины и знатоки, что пытаются дистанцироваться от политики обоих миров: вампирского и мирского.',
    ...
    tagline: 'Убийцы, воины и горлорезы',
    lordTitle: 'Лорд',
  },
};

const RU_CAITIFF: ClanLoc = {
  name: 'Свой Клан Каинитов',
...
const RU_TRAITS_BY_NAME: Record<string, { name: string; desc: string }> = {
  ...
  'Brooding Soul': {
    ...
    desc: 'Дебаффы настроения переносяться тяжелее, чем у других.',
  },
  'Self-Sustenance': {
  ...
  'Uncapped Strength': {
    ...
    desc: 'Твоя истинная мощь не имеет смертного предела.',
  },
  "Appraiser's Eye": {
    name: 'Глаз Оценщика',
...
const RU_COVENS_BY_NAME: Record<string, { name: string; desc: string }> = {
  ...
  Bloodheal: {
    ...
    desc: 'Используй силу крови, чтобы постепенно восстанавливать плоть.',
  },
  Celerity: {
    name: 'Стремительность',
    desc: 'Устремитесь к звездам. Превзойдите пределы скорости смертного тела. Нарушает Маскарад.',
  },
  Demonic: {
    name: 'Демонические дары',
    desc: 'Овладейте пламенем, подобно демонам и получите сверхестественную силу. Нарушает Маскарад',
  },
  'Eoran Embrace': {
    name: 'Объятие Эоры',
    desc: 'Благословлены Богиней Любви, Семьи и Искусства. Эти вампиры научились понимать людскую природу лучше других и даже исцелять раны смертных.',
  },
  'Fae Trickery': {
    name: 'Уловки Фей',
    desc: 'Этот ковен обычно развивается у вампиров, рождённых близ мест, где обитают феи.',
  },
  Obfuscate: {
    name: 'Сокрытие',
  ...
  Quietus: {
    name: 'Смертоносность',
    desc: 'Живи в тенях, разя лишь тогда, когда это нужно. Пламя и яды.',
  },
  'Siren Blessing': {
...
const RU_POWERS_BY_NAME: Record<string, { name: string; desc: string }> = {
  ...
  'Minor Bloodheal': {
    ...
    desc: 'Медленно затягивай мелкие раны, жертвуя силу крови.',
  },
  Bloodheal: {
    name: 'Кровавое Исцеление',
  ...
  'Quick Bloodheal': {
    name: 'Быстрое Быстрое Кровавое Исцеление',
  ...
  'Celerity 1': {
    ...
    desc: 'Повысьте свою скорость, чтобы всё давалось чуть проще.',
  },
  'Celerity 2': {
    name: 'Стремительность',
  ...
  'Celerity 3': {
    name: 'Сверхлюдская Стремительность',
  ...
  'Empathic Bond': {
    ...
    desc: 'Прикосновением считай эмоциональное состояние и нужды цели — на короткий срок становишься ею одержим. Усиливает гипноз',
  },
  'Artistic Inspiration': {
    name: 'Художественное Вдохновение',
    desc: 'Вдохни в других божественную творческую искру, усиливая их изыскания и повышая настроение.',
  },
  'Familial Bond': {
    name: 'Семейные Узы',
  ...
  "Baal's Caress": {
    name: 'Ласка Баала',
    desc: 'Преврати свою кровь в токсин, разъедающий любую плоть. Применяется на ОСТРОМ оружии.',
  },
  'Taste of Death': {
    name: 'Вкус Смерти',
